...
"""autogenerated by genpy from package_1/Custom.msg. Do not edit."""
import codecs
import sys
...
class Custom(genpy.Message):
  _md5sum = "df4cbcc180f9e5f7082067ab54c916f7"
  _type = "package_1/Custom"
...
float64 z
"""
  __slots__ = ['header','message','coordinate']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.coordinate is None:
        self.coordinate = geometry_msgs.msg.Point()
    else:
      self.header = std_msgs.msg.Header()
      self.message = ''
      self.coordinate = geometry_msgs.msg.Point()
